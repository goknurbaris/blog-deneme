<?php $__env->startSection('title', 'Yeni Yazı Ekle'); ?>
...
<div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mt-6">
    ...
    <form action="<?php echo e(route('blog.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <textarea id="editor" name="content" placeholder="Nelerden bahsetmek istersin?"><?php echo e(old('content')); ?></textarea>
        </div>
        ...
        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-100">
            <a href="<?php echo e(route('blog.index')); ?>" class="px-6 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition shadow-sm">İptal Et</a>
